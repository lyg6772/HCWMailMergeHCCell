...
def set_hancom_registry():
    dll_path = f'{os.getcwd()}\FilePathCheckerModuleExample.dll'
    reg_path = 'SOFTWARE\HNC\HwpAutomation\Modules'
    reg_key = reg.OpenKey(reg.HKEY_CURRENT_USER, reg_path, 0, reg.KEY_WRITE)
    reg.SetValueEx(reg_key, "AutomationModule", 0, reg.REG_SZ, dll_path)
